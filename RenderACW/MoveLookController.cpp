...
bool MoveLookController::getFoward()
{
	return m_forward;
}

bool MoveLookController::getBack()
{
	return m_back;
}

bool MoveLookController::getUp()
{
	return m_up;
}

bool MoveLookController::getDown()
{
	return m_down;

}

bool MoveLookController::getLeft()
{
	return m_left;
}

bool MoveLookController::getRight()
{
	return m_right;
}

bool MoveLookController::getRotX()
{
	return m_RotX;
}

bool MoveLookController::getRotY()
{
	return m_RotY;
}

bool MoveLookController::getRotZ()
{
	return m_RotZ;
}

bool MoveLookController::getScaleX()
{
	return m_ScaleX;
}

bool MoveLookController::getScaleY()
{
	return m_ScaleY;
}

bool MoveLookController::getScaleZ()
{
	return m_ScaleZ;
}

bool MoveLookController::getOtherRotX()
{
	return m_MinusRotX;
}

bool MoveLookController::getOtherRotY()
{
	return m_MinusRotY;
}

bool MoveLookController::getOtherRotZ()
{
	return m_MinusRotZ;
}

bool MoveLookController::getOtherScaleX()
{
	return m_MinusScaleX;
}

bool MoveLookController::getOtherScaleY()
{
	return m_MinusScaleY;
}

bool MoveLookController::getOtherScaleZ()
{
	return m_MinusScaleZ;
}
